                ...
                <c:forEach items="${actionBean.conceptFieldsOrder}" var="orderRow" varStatus="orderLoopStatus">
                    ...
                    <c:if test="${orderRow.property != null && orderRow.property eq 'LABEL'}">
                        <tr>
		                    ...
		                    <td class="simple_attr_help"><dd:mandatoryIcon /></td>
		                    <td class="simple_attr_value"><stripes:text name="vocabularyConcept.label" style="width: 500px;" class="smalltext"/></td>
		                </tr>
                    </c:if>
                    <c:if test="${orderRow.property != null && orderRow.property eq 'DEFINITION'}">
                        <tr>
		                    ...
		                    <td class="simple_attr_help"><dd:optionalIcon /></td>
		                    <td class="simple_attr_value"><stripes:textarea name="vocabularyConcept.definition" rows="3" cols="60" class="smalltext"/></td>
		                </tr>
                    </c:if>
                    ...
                    <c:if test="${orderRow.property != null && orderRow.property eq 'NOT_ACCEPTED_DATE'}">
                        <tr>
		                    <th scope="row" class="scope-row simple_attr_title">Not Accepted Date</th>
		                    <td class="simple_attr_help"></td>
		                    <td class="simple_attr_value">
                    ...
                    <c:if test="${orderRow.property == null && orderRow.boundElement != null}">
                        ...
                        <c:forEach var="elementValues" items="${actionBean.vocabularyConcept.elementAttributes}" varStatus="outerLoop">
		                    ...
		                    <c:if test="${attrMeta.id == orderRow.boundElement.id}">
			                    <tr>
			                        <th scope="row" class="scope-row simple_attr_title">
			                                ${attrMeta.name}
			                        </th>
